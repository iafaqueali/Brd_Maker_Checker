		...
		<div class="box">
		  ...
		  <form>
			...
			<input class="form-control" path="primaryContactPerson" type="text" placeholder="Enter primary Contact Person name" required>
			  ...
			  <select class="form-select mt-3 form-select-lg mb-3" aria-label=".form-select-lg example" class="flag_status" aria-placeholder="Flag Status">
			   <option selected >Flag Status</option>
